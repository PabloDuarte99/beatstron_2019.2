<%-- 
    Document   : ValorAPagarOperacon
    Created on : 07-may-2019, 17:39:01
    Author     : VENGA
--%>
    ...
    <body id="organizador">
        ...
        <form class="Artista">
            <div id="contenerdorUno">
                <table >
                    <tr>
                    <h3>Registro y modificación de premio</h3>
                    <td id="textStyle">
                        <strong> tipo de premio </strong>
                    </td>

                    <td align="left" id="imputStyle">
                        <input type="text" class="GanarOro" id="GanarOro" name="GanarOro" placeholder="ejemplo: 123,3" required>
                    </td>
                    ...
                    <tr>
                        <td id="textStyle">
                            <strong> Cantidad para ganar plata </strong>
                        </td>


                        <td align="left" id="imputStyle">
                            <input type="text" class="Ganarplata" id="Ganarplata" name="Ganarplata"
                                   placeholder="ejemplo: 123,2" required>
                        </td>
                ...
                <div id="Boton">
                    ...
                    <br>
                    <br>
                    <input type="button" value="Buscar" id="botones">
                </div>
                <h3>.</h3>
            </div>
        </form>
